...
<CardGroup cols={2}>
  ...
  <Card title="Capture Pipeline" icon="download">
...
<AccordionGroup>
  <Accordion title="public.apify_ads_raw" icon="table">
    **Type**: Table
  ...
  <Accordion title="public.ads_feed_v2" icon="eye">
    **Type**: View
  ...
  <Accordion title="public.user_saved_ads" icon="bookmark">
    **Type**: Table
  ...
  <Accordion title="public.user_projects" icon="folder">
    **Type**: Table
  ...
  <Accordion title="public.user_saved_ad_projects" icon="link">
    **Type**: Table
  ...
  <Accordion title="public.user_saved_ads_feed_v1" icon="eye">
    **Type**: View
  ...
  <Accordion title="public.user_project_ads_feed_v1" icon="eye">
    **Type**: View
  ...
  <Accordion title="public.page_rip_log" icon="clock">
    **Type**: Table
  ...
  <Accordion title="public.fanbasis_webhook_log" icon="webhook">
    **Type**: Table
  ...
  <Accordion title="public.integration_secrets" icon="key">
    **Type**: Table
